...
import type {
  ArgentContractAbi,
  ArgentContractAbiInterface,
} from "../ArgentContractAbi";
...
export class ArgentContractAbi__factory {
  static readonly abi = _abi;
  static createInterface(): ArgentContractAbiInterface {
    return new utils.Interface(_abi) as ArgentContractAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ArgentContractAbi {
    return new Contract(address, _abi, signerOrProvider) as ArgentContractAbi;
  }
}
